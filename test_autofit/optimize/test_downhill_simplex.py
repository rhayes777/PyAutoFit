...
class TestDownhillSimplex(object):
    def test_constant(self, downhill_simplex, model):
    ...
    def test_constant_and_model(self, downhill_simplex, model):
        model.constant = MockClassNLOx4()
        ...
        assert result.constant.model.one == 0.0
        assert result.constant.model.two == 0.0
