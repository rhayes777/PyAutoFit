...
class TestOutput:
    ...
    def test__sample_model_instance_from_sample_index(
        self,
    ):
    ...
    def test__model_errors_at_sigma_limit(
        self,
    ):
        model = af.ModelMapper(mock_class=MockClassNLOx4)
        output = MockOutput(model=model, paths=Paths(),
        ...
        model_errors_instance = output.model_errors_instance_at_sigma_limit(sigma_limit=1.0)
