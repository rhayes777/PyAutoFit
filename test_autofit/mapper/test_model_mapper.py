...
class TestRegression(object):
    ...
    def test_param_name_distinction(self):
        ...
        mm.ls = af.CollectionPriorModel(
            [af.PriorModel(test_autofit.mock.RelativeWidth), af.PriorModel(
                test_autofit.mock.RelativeWidth)])
    ...
    def test_name_for_prior(self):
        ls = af.CollectionPriorModel(
            [test_autofit.mock.RelativeWidth(1, 2, 3), af.PriorModel(
                test_autofit.mock.RelativeWidth)])
...
class TestRealClasses(object):
    ...
    def test_combination(self):
        ...
        assert isinstance(model_map.source_light_profile, test_autofit.mock.EllipticalSersic)
        assert isinstance(model_map.lens_mass_profile,
                          test_autofit.mock.EllipticalCoredIsothermal)
        assert isinstance(model_map.lens_light_profile, test_autofit.mock.EllipticalCoreSersic)
...
class TestConfigFunctions:
    ...
    def test_inheritance(self):
        mapper = af.ModelMapper(
            ...
            geometry_profile=test_autofit.mock.EllipticalProfile)
    ...
    def test_true_config(self):
        ...
        assert isinstance(model_map.elliptical_profile_1, test_autofit.mock.EllipticalProfile)
        assert isinstance(model_map.elliptical_profile_2, test_autofit.mock.EllipticalProfile)
        assert isinstance(model_map.spherical_profile, test_autofit.mock.SphericalProfile)

        assert isinstance(model_map.sersic_light_profile, test_autofit.mock.EllipticalSersic)
        assert isinstance(model_map.exponential_light_profile,
                          test_autofit.mock.EllipticalExponential)
...
class TestModelInstancesRealClasses(object):
    ...
    def test__in_order_of_class_constructor___multiple_profiles(self):
        mapper = af.ModelMapper(
            ...
            profile_1=test_autofit.mock.EllipticalProfile, profile_2=GeometryProfile,
