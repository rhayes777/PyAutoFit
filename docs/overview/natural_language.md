...
This page walks a complete fit through **PyAutoFit** and
[autofit_assistant](https://github.com/PyAutoLabs/autofit_assistant) as a
conversation, and shows why PyAutoFit's named models, separate likelihood,
interchangeable searches and structured results make this workflow well
suited to AI agents. If you have not set the assistant up yet, start
with [Quick Start](https://pyautofit.readthedocs.io/en/latest/overview/quick_start.html).
