...
class TestGridSearchOptimizer(object):
    def test_config(self):
        assert non_linear.GridSearch(phase_path='', phase_name='').step_size == 0.1
...
def make_grid_search():
    ...
    try:
        ...
        pass
    return non_linear.GridSearch(phase_path='', phase_name=name, step_size=0.1)
...
class TestGridSearch(object):
    ...
    def test_checkpoint_properties(self, grid_search):
        ...
        grid_search = non_linear.GridSearch(phase_path='', phase_name="grid_search", step_size=0.1)
    ...
    def test_recover_bad_checkpoint(self, grid_search):
        ...
        grid_search = non_linear.GridSearch(phase_path='', phase_name="grid_search", step_size=0.2)
        grid_search.variable.one = mock.Galaxy
