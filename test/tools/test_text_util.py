...
def test__label_and_value_string():
    ...
    string1 = text_util.label_and_value_string(label='param00', value=2.0, whitespace=10)
    string2 = text_util.label_and_value_string(label='param000', value=2.0, whitespace=10)

    assert string0 == 'param0    2.00'
    assert string1 == 'param00   2.00'
    assert string2 == 'param000  2.00'

    string = text_util.label_and_value_string(label='param11', value=3.00, whitespace=20)

    assert string == 'param11             3.0000'

    string = text_util.label_and_value_string(label='param12', value=3.00, whitespace=15)
...
def test__label_value_and_limits_string():
    ...
    string = text_util.label_value_and_limits_string(label='param12', value=3.00, upper_limit=500.0, lower_limit=1.0,
                                                     whitespace=15)
...
def test__label_value_and_unit_string():
    ...
    string0 = text_util.label_value_and_unit_string(label='param0', value=2.0, unit='arcsec', whitespace=10)
    string1 = text_util.label_value_and_unit_string(label='param00', value=2.0, unit='mass', whitespace=10)
    string2 = text_util.label_value_and_unit_string(label='param000', value=2.0, unit='kg', whitespace=10)

    assert string0 == 'param0    2.00 arcsec'
    assert string1 == 'param00   2.00 mass'
    assert string2 == 'param000  2.00 kg'

    string = text_util.label_value_and_unit_string(label='param11', value=3.00, unit='kg', whitespace=20)

    assert string == 'param11             3.0000 kg'

    string = text_util.label_value_and_unit_string(label='param12', value=3.00, unit='kgs', whitespace=15)
