...
class Phase(p.AbstractPhase):
    ...
    def __init__(self, phase_path, phase_name, profile, constant_profile, optimizer_class=non_linear.MultiNest):
        super().__init__(phase_path=phase_path, phase_name=phase_name, optimizer_class=optimizer_class)
...
class TestCase(object):
    def test_integration(self):
        multinest = non_linear.MultiNest(phase_path='integration/', phase_name='test')
    ...
    def test_grid(self):
        grid_search = gs.GridSearch(phase_path='integration/', phase_name="integration_grid_search")
    ...
    def test_phase(self):
        phase = Phase(phase_path='integration/', phase_name="test_phase", profile=mock.EllipticalProfile,
    ...
    def test_classic_grid_search_phase(self):
        ...
        phase = Phase(phase_path='integration/', phase_name="test_classic_grid_search_phase", profile=mock.EllipticalProfile,
    ...
    def test_grid_search_phase(self):
        ...
        result = GridSearchPhase(phase_path='integration/', number_of_steps=2, phase_name="grid_search_phase",
